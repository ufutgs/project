...
object SSA {
    ...
    def insertPhis(pa:List[LabeledInstr], dft:DFTable, g:CFG):P = {
        ...
        .foldLeft(List[SSALabeledInstr]())((p_phis:L@@li:LabeledInstr) =>li match{
            case (l,instr) => e.get(l) match{
                case None => 
            }
        })
...
scala.runtime.Scala3RunTime$.assertFailed(Scala3RunTime.scala:11)
	scala.meta.internal.pc.MetalsInteractive$.contextOfPath(MetalsInteractive.scala:53)
